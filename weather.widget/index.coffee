options =
  city          : "Seattle"       # default city in case location detection fails
...
appearance =
  ...
  baseFontSize  : 36                # the base font size, the size of the temperature
  ...
  showForecast  : false              # set to true to show the 5 day forecast
